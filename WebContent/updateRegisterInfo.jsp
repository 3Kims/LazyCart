...
<body align="center">
	<h1>Update Registered Information</h1><p>
	<form id="registerFrm" method="post">
	<div id="infoInput">
		이름 &nbsp;&nbsp;<input type ="text" id="name" readonly="readonly" placeholder="${name}"><p><p>
		휴대전화 번호 &nbsp;&nbsp;<input type ="text" id="phone1" required="required" placeholder="${phone1}"> - <input type ="text" id="phone2" required="required" placeholder="${phone2}"> - <input type ="text" id="phone3" required="required" placeholder="${phone3}"><p>
		ID &nbsp;&nbsp;<input type ="text" id="id" readonly="readonly" placeholder="${id}">
		<span id="idCheck"></span><p>
		PW &nbsp;&nbsp;<input type ="password" id="password" required="required" placeholder="${password}"><p>
		PW확인 &nbsp;&nbsp;<input type ="password" id="passwordCheck" required="required"><p>
		주소 &nbsp;&nbsp;<input type ="text" id="address" placeholder="${address}"><p></p>
	</div><p>
	<div id="buttons">
